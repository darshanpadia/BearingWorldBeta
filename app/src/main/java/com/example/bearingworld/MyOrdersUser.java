...
public class MyOrdersUser extends AppCompatActivity {

    private FirebaseAuth mAuth;
    private User currentUser;
    private HashMap<String,Order> updatedList = new HashMap<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_orders_user);
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myOrdersList = currentUser.orders;



                for (Order order : myOrdersList.values()) {
                    ...
                    SingleOrderLLParams.setMargins(dP(5),dP(10),dP(5),dP(10));
                    ...
                    LinearLayout.LayoutParams productListParams = new LinearLayout.LayoutParams(
                            ViewGroup.LayoutParams.MATCH_PARENT,
                            ViewGroup.LayoutParams.WRAP_CONTENT
                    );
//                    productListParams.setMargins(dP(10),dP(5),dP(10),dP(5));
                    ...
                    ScrollView.LayoutParams productListLLParams = new ScrollView.LayoutParams(
                            ViewGroup.LayoutParams.MATCH_PARENT,
                            ViewGroup.LayoutParams.WRAP_CONTENT
                    );
...
//                        product.productTotalCost = Integer.parseInt(product.cost) * Integer.parseInt(product.quantity);
                    ...
                    myOrderDateLLParams.setMargins(dP(0),dP(5),dP(0),dP(0));
